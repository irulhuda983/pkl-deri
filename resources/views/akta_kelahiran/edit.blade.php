...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Data Akta Kelahiran</h6>
    </div>
    <div class="card-body">
        <form action="/akta-kelahiran/{{ $data->id }}/update" method="POST">
            @csrf
            <div class="form-group">
                <label for="no_seri_akta">No Seri Akta</label>
                <input type="text" class="form-control" id="no_seri_akta" aria-describedby="no_seri_akta" placeholder="Enter no seri akta" name="no_seri_akta" value="{{ $data->no_seri_akta }}">
